{{--
    Regisztrációs oldal nézet.
    Új felhasználói fiók létrehozására szolgáló AdminLTE alapú felület.
--}}
...
@section('auth_footer')
    {{-- Visszalépési lehetőség a bejelentkezéshez --}}
    <p class="my-0">
